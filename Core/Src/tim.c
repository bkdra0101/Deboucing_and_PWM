...
/* USER CODE BEGIN 1 */
#define PUSLE_PERIOD  	  (10)
#define PUSLE_PWM_PERIOD  (5)

void Start_Counting_Timer(void)
{
	LL_TIM_SetAutoReload(TIM4,PUSLE_PERIOD );
	LL_TIM_EnableUpdateEvent(TIM4);
	LL_TIM_EnableIT_UPDATE(TIM4);
	LL_TIM_EnableCounter(TIM4);

}
void start_timer_compare(void){
...
void start_timer_PWM(void){
	...
	LL_TIM_OC_SetCompareCH2(TIM4,PUSLE_PWM_PERIOD);
